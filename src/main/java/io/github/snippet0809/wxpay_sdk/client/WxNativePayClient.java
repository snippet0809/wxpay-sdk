...
public class WxNativePayClient extends WxPayClient {

    private final String appid;

    public WxNativePayClient(String appid, SignProducer signProducer, SignVerifier signVerifier) {
    ...
    public String ordering(OrderBody orderBody) throws IOException, WxPayApiException {
        return wxPayHttpClient.post(WxApi.TRANSACTION_NATIVE, JSONObject.toJSONString(orderBody));
    }
